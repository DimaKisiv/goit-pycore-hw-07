...
from upcoming import get_congratulation_date
...
class Record:
    def __init__(self, name):
        ...
        self.birthday = None
    def __str__(self):
        return f"Name: {self.name.value}, Phones: {'; '.join(p.value for p in self.phones)}, Birthday: {self.birthday.value.date()}, Congratulation: {self.congratulation_date}"
